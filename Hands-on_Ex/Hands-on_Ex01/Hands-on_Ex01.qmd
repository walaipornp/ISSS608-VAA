...
The code chunk below plots a boxplot showing race and English grades by using geom_boxplot().
...
The code chunk below plots a violin plot showing race and English grades by using geom_violin().
...
The code chunk below plots a scatterplot showing class and English grades by using geom_point().
...
The code chunk below plots a trellis plot of gender using `facet-wrap()`.
...
The code chunk below plots a trellis plot of race using `facet_grid()`.
...
A horizontal bar chart plotted using `theme_test()`.
...
A horizontal bar chart plotted using `theme_dark()`.
