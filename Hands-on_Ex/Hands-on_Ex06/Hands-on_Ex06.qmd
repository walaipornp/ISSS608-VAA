...
# 1. Visualizing and Analyzing Time-oriented Data

## 1.1 Learning Outcome

By the end of this hands-on exercise you will be able create the followings data visualization by using R packages:
...
### 1.3.1 Examining the data structure
...
### 1.3.3 Building the Calendar Heatmaps
...
Then we can simply group the count by hour and wkday and plot it, since we know that we have values for every combination there’s no need to further preprocess the data. \### 1.3.4 Building Multiple Calendar Heatmaps

### 1.3.5 Plotting Multiple Calendar Heatmaps
...
### 1.4.3 Step 3: Extracting the target country 
...
### 1.4.4 Step 4: Computing year average arrivals by month 
...
### 1.4.5 Step 5: Plotting the cycle plot 
