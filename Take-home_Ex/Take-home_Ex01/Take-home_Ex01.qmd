...
Descriptive bar charts were created using ggplot2 to summarize the demographic profile of students, including year of study, gender, household poverty status, and government policy support. Each variable was visualized separately using count-based bar charts and arranged in a combined layout for comparison.
...
- The student population is mainly composed of graduated students, with fewer third- and fourth-year students. The majority of respondents are female. Most students do not come from poor households, and more students are not receiving government policy support than those who are.

- students tend to report moderately positive perceptions of their university experience. Most students rated Adapt_Learning_Uni, SupportOf_Uni, and Quality_Lecturer positively (responses 3–5 dominate). However, Competitive_Class and Facilities show more mixed opinions, indicating potential areas for improvement. Influence from friends is generally perceived as moderate to high, suggesting peer relationships play an important role in academic life.
...
::: {.callout-tip title="Insight"}
The scatter plots show that students whose parents have higher education levels (especially university graduates) tend to cluster more around higher GPA levels, while students with parents who have only primary or secondary education show more variation and include more lower GPA values. This suggests that family educational background is associated with students’ academic performance, reflecting unequal opportunities linked to parental education.
:::
